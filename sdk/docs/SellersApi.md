...
|[**createProductWithImagesApiV1SellersProductsWithImagesPost**](#createproductwithimagesapiv1sellersproductswithimagespost) | **POST** /api/v1/sellers/products/with-images | Create Product With Images|
...
# **createProductWithImagesApiV1SellersProductsWithImagesPost**
> ProductResponse createProductWithImagesApiV1SellersProductsWithImagesPost()
...
let stockQuantity: number; // (optional) (default to 0)
let productType: string; // (optional) (default to undefined)
let images: Array<File>; // (optional) (default to undefined)

const { status, data } = await apiInstance.createProductWithImagesApiV1SellersProductsWithImagesPost(
    name,
    price,
    description,
    stockQuantity,
